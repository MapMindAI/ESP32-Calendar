...
static const char* const weekday_names[7] = {"MONDAY", "TUESDAY",  "WEDNESDAY", "THURSDAY",
...
int calendar_calc_days_in_year(int year) { return calendar_calc_is_leap_year(year) ? 366 : 365; }
